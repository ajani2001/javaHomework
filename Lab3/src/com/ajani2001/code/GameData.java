...
import com.ajani2001.code.exception.FigureConfigFileInvalidException;
import com.ajani2001.code.exception.FigureSpawnImpossibleException;
import com.ajani2001.code.exception.MyException;
import com.ajani2001.code.exception.ScoreTableFileInvalidException;
...
class Timer extends Thread {
    ...
    public Timer(GameData model) {
        this.model = model;
        delayMillis = 0;
    }

    public Timer(GameData model, int delayMillis) {
        this.model = model;
    ...
    public void run() {
        while(!(model.gameFinished || delayMillis <= 0 || isInterrupted())) {
            try {
                sleep(delayMillis);
            }
